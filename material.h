   ...
   public:
    ...
    __device__ bool scatter(
        ...
        if (type == 1) {
            ...
            return scatter2(r_in, rec, attenuation, scattered);
        } else {
            return scatter3(r_in, rec, attenuation, scattered);
        }
    }

    __device__ void setup1(const color& a) {
        albedo = a;
    }

    __device__ void setup2(const color& a, double f) {
        albedo = a;
        fuzz = f < 1 ? f : 1;
    }

    __device__ void setup3(double i) {
        ir = i;
    }
